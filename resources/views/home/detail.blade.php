        ...
        <div class="col-md-12">
            ...
            <div class="row mt-4">
                <div class="col-md-4">
                    ...
                    @else
                        <img src="https://via.assets.so/img.jpg?w=990&h=1400&tc=&bg=#cecece" alt="" class="card-img-top">
                    @endif
                </div>
                <div class="col-md-8">
                            ...
                            <div class="col-md-4 col-lg-4 mb-4">
                                <div class="card border-0 shadow-lg">
                                    <a href="{{route('home.detail', $randomBook->id)}}">
                                        @if ($randomBook->image != "")
                                            <img src="{{asset('/uploads/books/thumb/' . $randomBook->image)}}" alt="" class="card-img-top">
                                        @else
                                            <img src="https://via.assets.so/img.jpg?w=990&h=1400&tc=&bg=#cecece" alt="" class="card-img-top">
                                        @endif
                                    </a>
                                    <div class="card-body">
                                        <h3 class="h4 heading"><a href="{{route('home.detail', $randomBook->id)}}">{{$randomBook->title}}</a></h3>
                                    ...
                                    <div class="card border-0 shadow-lg my-4">
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <span class="text-muted">{{$review->created_at->format('M d, Y | H:i') }}</span>         
                                            </div>
                                        
                                            @php 
                                                $ratingrev = ($review->rating/5)*100;
                                            @endphp
                                                ...
                                                <div class="star-rating d-inline-flex" title="">
                                                    <div class="star-rating d-inline-flex " title="">
                                                        <div class="back-stars ">
                                                            ...
                                                            <div class="front-stars" style="width: {{$ratingrev}}%">
                                                                <i class="fa fa-star" aria-hidden="true"></i>
                                                                <i class="fa fa-star" aria-hidden="true"></i>
                                                                <i class="fa fa-star" aria-hidden="true"></i>
                                                                <i class="fa fa-star" aria-hidden="true"></i>
...
<div class="modal fade " id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="" id="bookReview" name="bookReview">
...
@section('script')
<script>
    $('#bookReview').submit(function(e){
        e.preventDefault();
        $.ajax({
            url: "{{route('home.review')}}",
            method: "POST",
            headers: {
                'X-CSRF-TOKEN': '{{csrf_token()}}'
            },
            data: $('#bookReview').serializeArray(),
            success: function(response){
                if(response.status == false){
                    var erors = response.erors;
                    if(erors.review){
                        $('#review').addClass('is-invalid');
                        $('#reviewError').html(erors.review);
                    }else{
